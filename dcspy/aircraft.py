...
class F16C50(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        self.bios_data: Dict[str, Union[BIOS_STR, BIOS_INT]] = {
            ...
            'DED_LINE_4': {'class': 'StringBuffer', 'args': {'address': 0x454e, 'max_length': 25}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'DED_LINE_5': {'class': 'StringBuffer', 'args': {'address': 0x4568, 'max_length': 25}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'IFF_MASTER_KNB': {'class': 'IntegerBuffer', 'args': {'address': 0x444a, 'mask': 0x700, 'shift_by': 0x8}, 'value': int(), 'max_value': 4, 'callback': 'set_bios', 'callback_args': {}},
            'IFF_ENABLE_SW': {'class': 'IntegerBuffer', 'args': {'address': 0x444e, 'mask': 0x3, 'shift_by': 0x0}, 'value': int(), 'max_value': 2, 'callback': 'set_bios', 'callback_args': {}},
            'IFF_M4_CODE_SW': {'class': 'IntegerBuffer', 'args': {'address': 0x444a, 'mask': 0x1800, 'shift_by': 0xb}, 'value': int(), 'max_value': 2, 'callback': 'set_bios', 'callback_args': {}},
            'IFF_M4_REPLY_SW': {'class': 'IntegerBuffer', 'args': {'address': 0x444a, 'mask': 0x6000, 'shift_by': 0xd}, 'value': int(), 'max_value': 2, 'callback': 'set_bios', 'callback_args': {}}}
