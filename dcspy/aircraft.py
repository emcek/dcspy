...
class Aircraft:
    ...
    def get_next_value_for_button(self, btn_name: str) -> int:
        ...
        max_val = self.bios_data[btn_name]['args']['max_value']  # type: ignore
...
class FA18Chornet(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        self.bios_data: Dict[str, BIOS] = {
            'UFC_SCRATCHPAD_STRING_1_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x744e, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_SCRATCHPAD_STRING_2_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7450, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_SCRATCHPAD_NUMBER_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7446, 'max_length': 0x8}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_DISPLAY_1': {'class': 'StringBuffer', 'args': {'address': 0x7432, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_DISPLAY_2': {'class': 'StringBuffer', 'args': {'address': 0x7436, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_DISPLAY_3': {'class': 'StringBuffer', 'args': {'address': 0x743a, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_DISPLAY_4': {'class': 'StringBuffer', 'args': {'address': 0x743e, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_DISPLAY_5': {'class': 'StringBuffer', 'args': {'address': 0x7442, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_COMM1_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7424, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_COMM2_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7426, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_CUEING_1': {'class': 'StringBuffer', 'args': {'address': 0x7428, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_CUEING_2': {'class': 'StringBuffer', 'args': {'address': 0x742a, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_OPTION_CUEING_3': {'class': 'StringBuffer', 'args': {'address': 0x742c, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
...
class F16C50(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        super().__init__(lcd_type)
        self.bios_data: Dict[str, BIOS] = {
            'DED_LINE_1': {'class': 'StringBuffer', 'args': {'address': 0x4500, 'max_length': 0x19}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'DED_LINE_2': {'class': 'StringBuffer', 'args': {'address': 0x451a, 'max_length': 0x19}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'DED_LINE_3': {'class': 'StringBuffer', 'args': {'address': 0x4534, 'max_length': 0x19}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'DED_LINE_4': {'class': 'StringBuffer', 'args': {'address': 0x454e, 'max_length': 0x19}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'DED_LINE_5': {'class': 'StringBuffer', 'args': {'address': 0x4568, 'max_length': 0x19}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
...
class Ka50(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        self.bios_data: Dict[str, BIOS] = {
            ...
            'PVI_LINE1_POINT': {'class': 'StringBuffer', 'args': {'address': 0x1930, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'PVI_LINE1_SIGN': {'class': 'StringBuffer', 'args': {'address': 0x1920, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'PVI_LINE1_TEXT': {'class': 'StringBuffer', 'args': {'address': 0x1924, 'max_length': 0x6}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'PVI_LINE2_APOSTROPHE1': {'class': 'StringBuffer', 'args': {'address': 0x1938, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'PVI_LINE2_APOSTROPHE2': {'class': 'StringBuffer', 'args': {'address': 0x193a, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
...
class A10C(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        super().__init__(lcd_type)
        self.bios_data: Dict[str, BIOS] = {
            'VHFAM_FREQ1': {'class': 'StringBuffer', 'args': {'address': 0x1190, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFAM_FREQ2': {'class': 'IntegerBuffer', 'args': {'address': 0x118e, 'mask': 0xf0, 'shift_by': 0x4, 'max_value': 0x9}, 'value': int(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFAM_FREQ3': {'class': 'IntegerBuffer', 'args': {'address': 0x118e, 'mask': 0xf00, 'shift_by': 0x8, 'max_value': 0x9}, 'value': int(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFAM_FREQ4': {'class': 'StringBuffer', 'args': {'address': 0x1192, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFFM_FREQ1': {'class': 'StringBuffer', 'args': {'address': 0x119a, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFFM_FREQ2': {'class': 'IntegerBuffer', 'args': {'address': 0x119c, 'mask': 0xf, 'shift_by': 0x0, 'max_value': 0x9}, 'value': int(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFFM_FREQ3': {'class': 'IntegerBuffer', 'args': {'address': 0x119c, 'mask': 0xf0, 'shift_by': 0x4, 'max_value': 0x9}, 'value': int(), 'callback': 'set_bios', 'callback_args': {}},
            'VHFFM_FREQ4': {'class': 'StringBuffer', 'args': {'address': 0x119e, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UHF_100MHZ_SEL': {'class': 'StringBuffer', 'args': {'address': 0x1178, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
...
class AV8BNA(Aircraft):
    def __init__(self, lcd_type: LcdInfo) -> None:
        ...
        super().__init__(lcd_type)
        self.bios_data: Dict[str, BIOS] = {
            'UFC_SCRATCHPAD': {'class': 'StringBuffer', 'args': {'address': 0x7984, 'max_length': 0xc}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_COMM1_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7954, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'UFC_COMM2_DISPLAY': {'class': 'StringBuffer', 'args': {'address': 0x7956, 'max_length': 0x2}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_1_SELECT': {'class': 'StringBuffer', 'args': {'address': 0x7966, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_1_Text': {'class': 'StringBuffer', 'args': {'address': 0x7968, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_2_SELECT': {'class': 'StringBuffer', 'args': {'address': 0x796c, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_2_Text': {'class': 'StringBuffer', 'args': {'address': 0x796e, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_3_SELECT': {'class': 'StringBuffer', 'args': {'address': 0x7972, 'max_length': 0x1}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
            'AV8BNA_ODU_3_Text': {'class': 'StringBuffer', 'args': {'address': 0x7974, 'max_length': 0x4}, 'value': str(), 'callback': 'set_bios', 'callback_args': {}},
