[![image](https://img.shields.io/badge/pypi-v3.8.1-blue.svg)](https://pypi.org/project/dcspy/)
...
[![image](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13%20%7C%203.14-blue.svg)](https://github.com/emcek/dcspy)
...
* DCS World: [2.9.26.23111.1](https://www.digitalcombatsimulator.com/en/news/changelog/stable/2.9.26.23111.1/), but any version from 2.9.* branch should be fine.
* optional:
