...
[![image](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12%20%7C%203.13-blue.svg)](https://github.com/emcek/dcspy)
...
* DCS-Skunkworks DCS-BIOS:
  * [DCS-BIOS 0.8.4](https://github.com/DCS-Skunkworks/dcs-bios/releases/tag/v0.8.4) or newer (can be [installed](https://dcspy.readthedocs.io/en/latest/upgrade/#manual-procedure) directly from DCSpy)
...
* DCS World: [2.9.23.18431](https://www.digitalcombatsimulator.com/en/news/changelog/stable/2.9.23.18431/), but any version from 2.9.* branch should be fine.
* optional:
  * [Python 3.13](https://www.python.org/downloads/) but 3.10+ should be fine (see [installation](https://dcspy.readthedocs.io/en/latest/install/))
