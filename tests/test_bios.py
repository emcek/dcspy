...
def test_bios_values_for_shark(black_shark_mono):
    ...
    results = _check_dcsbios_data(black_shark_mono.bios_data, local_json)
    print('\nShark BIOS Report\n-----------------')
    pprint(results)
    # assert not results
...
def test_bios_values_for_viper(viper_mono):
    ...
    results = _check_dcsbios_data(viper_mono.bios_data, local_json)
    print('\nViper BIOS Report\n-----------------')
    pprint(results)
    # assert not results
...
def test_bios_values_for_hornet(hornet_mono):
    ...
    results = _check_dcsbios_data(hornet_mono.bios_data, local_json)
    print('\nHornet BIOS Report\n------------------')
    pprint(results)
    # assert not results
...
def test_bios_values_for_tomcat(tomcat_mono):
    ...
    results = _check_dcsbios_data(tomcat_mono.bios_data, local_json)
    print('\nTomcat BIOS Report\n------------------')
    pprint(results)
    # assert not results
...
def _check_dcsbios_data(plane_bios: dict, local_json) -> dict:
    results = {}
