...
@mark.parametrize('keyboard, pressed1, effect1, effect2, chk_btn, calls, pressed2', [
    ...
    ('keyboard_mono', False, [False] * 3, [str(i) for i in generate_gkey(3, 1)], Gkey(key=0, mode=0), [call(g_key=1, mode=1), call(g_key=2, mode=1), call(g_key=3, mode=1)], False),
    ('keyboard_color', False, [False] * 3, [str(i) for i in generate_gkey(3, 1)], Gkey(key=0, mode=0), [call(g_key=1, mode=1), call(g_key=2, mode=1), call(g_key=3, mode=1)], False),
